...
_timer_isr:									; procedura obs³ugi przerwania timera
	push R16
	in R16, SREG
	//clr PulseEdgeCtrL						; do sprawdzenia przerwania 0 licznik co przerwanie (czyli 1s)
	//clr PulseEdgeCtrH									
	inc R11
	out SREG, R16
	pop R16
...
MainLoop:
	...
	movw Digit_1:Digit_0, R17:R16
	movw Digit_3:Digit_2, R19:R18
	SET_DIGIT 0					
	SET_DIGIT 1
	SET_DIGIT 2
	SET_DIGIT 3
	...
	ldi R28, 1
	add PulseEdgeCtrL, R28
	clr R28
	adc PulseEdgeCtrH, R28
rjmp MainLoop
