...
_main:
	...
	out TCNT1L, R16
	out TCNT1H, R16
	ldi R16, 32					; PB0 - PCINT0:Pin Change Interrupt 0, Source 0
	out GIMSK, R16				; General Interrupt Mask Register, Bit 5 – PCIE0: Pin Change Interrupt Enable 0
	ldi R16, 1					; pin change interrupt is enabled on the corresponding I/O pin - PCINT0
